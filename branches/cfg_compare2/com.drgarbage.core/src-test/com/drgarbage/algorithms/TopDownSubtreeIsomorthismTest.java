...
public class TopDownSubtreeIsomorthismTest extends TestCase {
	...
	private TestSet createTestSet6(){
		TestSet t = new TestSet();
		...
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v7, v5));
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v7, v6));
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v4, v8));
	...
	/**
	 * Test method indicates no subtree match
	 * @throws ControlFlowGraphException 
	 * @see #createTestSet1()
	 */
	public final void testTopDownSubtreeIsomorthism6() throws ControlFlowGraphException {	
		TopDownSubtreeIsomorphism tsi = new TopDownSubtreeIsomorphism();
		TestSet t = createTestSet6();
		printGraph(t.treeLeft);
		printGraph(t.treeRight);
		Map<INodeExt, INodeExt> map = tsi.topDownUnorderedSubtreeIsomorphism(t.treeLeft, t.treeRight);
		printMap(map);
