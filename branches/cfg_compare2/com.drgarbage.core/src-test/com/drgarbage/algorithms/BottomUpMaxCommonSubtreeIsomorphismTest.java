...
/**
 * Test class for {@link com.drgarbage.algorithms.BottomUpMaxCommonSubtreeIsomorphism}
 * 
 * @author Adam Kajrys
 * 
 * @version $Revision$
 * $Id$
 */
public class BottomUpMaxCommonSubtreeIsomorphismTest extends TestCase {
	 ...
	 * {@link com.drgarbage.algorithms.BottomUpMaxCommonSubtreeIsomorphism BottomUpMaxCommonSubtreeIsomorphism}.
	 * 
	 * Expected map is 
	 * <pre>
	 *  v6 = w11
	...
	private TestSet createTestSet1(){
		...
		INodeExt v13 = GraphExtentionFactory.createNodeExtention("v13");
		t.treeLeft.getNodeList().add(v13);
		INodeExt v14 = GraphExtentionFactory.createNodeExtention("v14");
		t.treeLeft.getNodeList().add(v14);
		INodeExt v15 = GraphExtentionFactory.createNodeExtention("v15");
		t.treeLeft.getNodeList().add(v15);

		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v15, v8));
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v15, v14));
		...
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v14, v12));
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v14, v13));
	...
	private TestSet createTestSet3(){
		...
		t.treeLeft.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(v3, v4));
		...
		t.treeRight.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(w2, w3));
		t.treeRight.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(w2, w4));
		t.treeRight.getEdgeList().add(GraphExtentionFactory.createEdgeExtention(w3, w5));
	...
	/**
	 * Test method for {@link com.drgarbage.algorithms.BottomUpMaxCommonSubtreeIsomorphism BottomUpMaxCommonSubtreeIsomorphism}
	 * @throws ControlFlowGraphException 
	 * @see #createTestSet1()
	 */
	public final void testBottomUpUnorderedMaxCommonSubtreeIsomorphism1() throws ControlFlowGraphException {	
	 ...
	 * The same test set as for {@link #testBottomUpUnorderedMaxCommonSubtreeIsomorphism1()} 
	 * but the input trees <code>T1</code> and <code>T2</code> are swapped.
	 * @throws ControlFlowGraphException 
	 * @see #createTestSet1()
	 */
	public final void testBottomUpUnorderedMaxCommonSubtreeIsomorphism2() throws ControlFlowGraphException {		
		BottomUpMaxCommonSubtreeIsomorphism bumcsi = new BottomUpMaxCommonSubtreeIsomorphism();
		TestSet t = createTestSet1();
	...
	/**
	 * Test method for {@link com.drgarbage.algorithms.BottomUpSubtreeIsomorphism bottomUpUnorderedMaxCommonSubreeIsomorphism}
